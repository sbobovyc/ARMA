...
THE_UNSUNG_VIETNAM_WAR_MOD_ID=943001311
LEN_COLD_WAR_HELICOPTERS_ID=1739706180
...
download_mod $IFA3_AIO_LITE
download_mod $THE_UNSUNG_VIETNAM_WAR_MOD_ID
download_mod $LEN_COLD_WAR_HELICOPTERS_ID
...
ln -s -T $WORKSHOP_DIR/$ARMA_ID/$IFA3_AIO_LITE $INSTALL_DIR/@ifa3_aio_lite
ln -s -T $WORKSHOP_DIR/$ARMA_ID/$THE_UNSUNG_VIETNAM_WAR_MOD_ID $INSTALL_DIR/@unsung_vietnam_war
ln -s -T $WORKSHOP_DIR/$ARMA_ID/$LEN_COLD_WAR_HELICOPTERS_ID $INSTALL_DIR/@len_cold_war_helicopters
